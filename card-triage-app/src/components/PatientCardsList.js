  ...
  return (
    <div className="cards-list shadow">
      ...
      <div className="list-group overflow-auto">
        <PatientCardItem pName="Bob" pId="3456" date="2020-03-10T13:14:59+0000" arrhythmias="a, b, c" status={props.status}></PatientCardItem>
        <PatientCardItem status={props.status}></PatientCardItem>
        <PatientCardItem status={props.status}></PatientCardItem>
        <PatientCardItem status={props.status}></PatientCardItem>
        <PatientCardItem status={props.status}></PatientCardItem>
        <PatientCardItem status={props.status}></PatientCardItem>
